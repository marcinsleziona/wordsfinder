...
public interface IWordsService {
    ...
    /**
     * finds all possible words that contain all the provide letters.
    ...
    /**
     * find all possible words that can be build with the letters from 2-digits up to amount of letters
